...
class Adopterall extends StatefulWidget {
  const Adopterall({super.key});

  @override
  State<Adopterall> createState() => _AdopterallState();
}

class _AdopterallState extends State<Adopterall> {
  List<Widget> widgets = [];
