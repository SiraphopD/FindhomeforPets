...
class Adopterdog extends StatefulWidget {
  const Adopterdog({super.key});

  @override
  State<Adopterdog> createState() => _AdopterdogState();
}

class _AdopterdogState extends State<Adopterdog> {
  List<Widget> widgets = [];
