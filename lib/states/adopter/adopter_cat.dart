...
class Adoptercat extends StatefulWidget {
  const Adoptercat({super.key});

  @override
  State<Adoptercat> createState() => _AdoptercatState();
}

class _AdoptercatState extends State<Adoptercat> {
  List<Widget> widgets = [];
