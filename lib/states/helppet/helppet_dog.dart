...
class HelpPet_dog extends StatefulWidget {
  const HelpPet_dog({super.key});

  @override
  State<HelpPet_dog> createState() => _HelpPet_dogState();
}

class _HelpPet_dogState extends State<HelpPet_dog> {
  String? userID,
      displayName,
      Surname,
      uid,
