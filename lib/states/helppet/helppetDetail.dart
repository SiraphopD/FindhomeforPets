...
class HelppetDetail extends StatefulWidget {
  late final PetModel petModel;
  HelppetDetail({Key? key, required this.petModel}) : super(key: key);

  @override
  State<HelppetDetail> createState() => _HelppetDetailState();
}

class _HelppetDetailState extends State<HelppetDetail> {
  late PetModel model;
