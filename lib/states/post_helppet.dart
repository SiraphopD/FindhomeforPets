...
class Posthelppet extends StatefulWidget {
  const Posthelppet({super.key});

  @override
  State<Posthelppet> createState() => _PosthelppetState();
}

class _PosthelppetState extends State<Posthelppet> {
  File? file;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('โพสต์ช่วยเหลือสัตว์'),
  ...
  Future<void> uploadPictureTostorage() async {
    ...
    Reference storagereference =
        firebaseStorage.ref().child('helppet/mpets$i.jpg');
  ...
  Future<void> insertValueToFirestore() async {
    ...
    final docID = firebaseFirestore.collection('helppet').doc();
    petID = docID.id;
    ...
    await firebaseFirestore
      ...
      // Navigator.pushNamedAndRemoveUntil(context, '/helppet', (route) => false);
    });
  }
