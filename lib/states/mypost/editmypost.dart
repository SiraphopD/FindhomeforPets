...
class Editmypost extends StatefulWidget {
  ...
  const Editmypost({Key? key, required this.petModel}) : super(key: key);

  @override
  State<Editmypost> createState() => _Editmypost1State();
}

class _Editmypost1State extends State<Editmypost> {
  late PetModel model;
  ...
  void initState() {
    ...
    vaccinecontroller.text = model.vaccine;
      ...
      children: [
        ...
        Container(
          ...
          child: TextFormField(
            ...
            onChanged: (value) => newage = value.trim(),
      ...
      children: [
        ...
        Container(
          ...
          child: TextFormField(
            ...
            onChanged: (value) => newvaccine = value.trim(),
            decoration: InputDecoration(
              labelStyle: MyStyle().darkStyle(),
              hintText: '$vaccine',
              hintStyle: TextStyle(
  ...
  Future<void> uploadPictureTostorage() async {
    ...
    Reference storagereference =
        firebaseStorage.ref().child('petspic/pets$i.jpg');
  ...
  Future<void> updateage() async {
    await FirebaseFirestore.instance
        .collection('pets')
        .doc(petID)
        .update({'age': newage}).then((value) {
      print('#########UPDATE SUCCESS :${age}');
      updatepetgender();
    });
  }
  ...
  Future<void> updatevaccine() async {
    await FirebaseFirestore.instance
        .collection('pets')
        .doc(petID)
        .update({'vaccine': newvaccine}).then((value) {
      print('#########UPDATE SUCCESS :${vaccine}');
      updateprovince();
