...
class Editmypost3 extends StatefulWidget {
  final PetModel petModel;
  const Editmypost3({Key? key, required this.petModel}) : super(key: key);

  @override
  State<Editmypost3> createState() => _Editmypost1State();
}

class _Editmypost1State extends State<Editmypost3> {
  late PetModel model;
