...
class createGoogleAcc extends StatefulWidget {
  @override
  _createGoogleAccState createState() => _createGoogleAccState();
}

class _createGoogleAccState extends State<createGoogleAcc> {
  File? file;
    ...
    await Firebase.initializeApp().then((value) async {
      await _googleSignIn.signIn().then((value) async {
        ...
        await value.authentication.then((value2) async {
          ...
          (onError) => normailDialog(context, onError.code, onError.message));
    });
  }
